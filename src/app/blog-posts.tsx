  ...
  return (
    <section className="w-full max-w-6xl mx-auto flex flex-col items-center px-4 py-20">
      <Button placeholder=""
        ...
        onPointerLeaveCapture={undefined} color="gray" className="mb-3" size="sm">
        BLOG
      </Button>
      <Typography placeholder=""
        onPointerEnterCapture={undefined}
        onPointerLeaveCapture={undefined} variant="h3" className="text-center" color="blue-gray">
      ...
      <div className="mt-10 gap-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <div className=" md:border-r px-3 border-blue-gray-100">
          <div className="!border-b  border-blue-gray-100 mb-5">
            <Card placeholder=""
              onPointerEnterCapture={undefined}
              onPointerLeaveCapture={undefined} shadow={false} className="p-0">
              <Card placeholder=""
                onPointerEnterCapture={undefined}
                onPointerLeaveCapture={undefined} className="p-0 pb-5">
                <Typography placeholder=""
                  onPointerEnterCapture={undefined}
                  onPointerLeaveCapture={undefined}
                  variant="h3"
                ...
                <Typography placeholder=""
                  onPointerEnterCapture={undefined}
                  onPointerLeaveCapture={undefined} className="text-normal mb-4 !text-base text-blue-gray-500 ">
          ...
          <div className="!border-b  border-blue-gray-100 mb-6">
            <Card placeholder=""
              ...
              <Card placeholder=""
                ...
                <Typography placeholder=""
                  onPointerEnterCapture={undefined}
                  onPointerLeaveCapture={undefined} className="!font-bold !text-sm text-gray-700">
                  by Mathew Glock
                </Typography>
              </Card>
            </Card>
